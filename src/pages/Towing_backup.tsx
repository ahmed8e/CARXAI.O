...
const TRUST_MESSAGES = [
  'Verified provider in the Car Safety assistance network.',
  'Trusted nearby roadside assistance, available now.',
  'Reliable local automotive support through Car Safety.',
  'Nearby verified help when you need it most.',
  'Available through the Car Safety assistance network.',
]
  ...
  return (
    <div className={`relative flex items-center justify-center overflow-hidden bg-gradient-to-br from-navy/5 to-navy/10 ${className}`}>
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="text-[7px] font-black uppercase tracking-[0.2em] text-navy/30">Car Safety</p>
      </div>
    </div>
  )
}
