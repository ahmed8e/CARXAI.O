    ...
    <div className="p-6 lg:p-10 max-w-6xl mx-auto min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div>
          ...
          <h1 className="text-4xl md:text-5xl font-display font-black text-slate-900 italic tracking-tight">My Vehicles</h1>
          <p className="text-slate-500 font-medium mt-2">Manage your fleet for precise AI diagnosis and maintenance.</p>
        </div>
