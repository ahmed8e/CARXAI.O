        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col items-start gap-6">
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 border border-blue-100/50">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-[#0070E0]">{t('landing.footer.secure_badge')}</span>
            </div>
          </div>

          {/* Platform Column */}
          <div>
            <h4 className="text-sm font-black uppercase tracking-[0.15em] mb-8 text-slate-900">{t('landing.footer.platform')}</h4>
            <ul className="space-y-4">
              {[
                { name: t('landing.nav.features'), id: 'features' },
                { name: t('landing.nav.how_it_works'), id: 'problem' },
          ...
          {/* Company Column */}
          <div>
            <h4 className="text-sm font-black uppercase tracking-[0.15em] mb-8 text-slate-900">{t('landing.footer.resources')}</h4>
            <ul className="space-y-4">
              <li>
                <button 
                ...
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-[#0070E0] mr-0 w-0 opacity-0 group-hover:w-2 group-hover:mr-2 group-hover:opacity-100 transition-all duration-300"></span>
                  {t('landing.footer.how_it_began')}
                </button>
              </li>
              {[
                { name: t('landing.footer.documentation'), icon: FileText, href: '#' },
                { name: t('landing.footer.tech_support'), icon: LifeBuoy, href: 'https://wa.me/447907357259' }
              ].map((item) => (
                <li key={item.name}>
                  <a 
                    href={item.href}
          ...
          {/* Contact Column */}
          <div>
            <h4 className="text-sm font-black uppercase tracking-[0.15em] mb-8 text-slate-900">{t('landing.footer.contact')}</h4>
            <ul className="space-y-5">
              <li className="flex items-start gap-4 group">
                ...
                <div className="flex flex-col">
                  <span className="text-[11px] font-black uppercase tracking-widest text-slate-400 mb-0.5">{t('landing.footer.hq')}</span>
              ...
              <li>
                <a href="mailto:support@carsafety.online" className="flex items-center gap-4 group">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[11px] font-black uppercase tracking-widest text-slate-400 mb-0.5">{t('landing.footer.email_us')}</span>
              ...
              <li>
                <a href="tel:+442079460123" className="flex items-center gap-4 group">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[11px] font-black uppercase tracking-widest text-slate-400 mb-0.5">{t('landing.footer.phone')}</span>
        ...
        <div className="mt-20 pt-10 border-t border-slate-100">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex items-center gap-8">
              <Link to="/privacy" className="text-slate-400 hover:text-[#0070E0] text-[13px] font-bold transition-colors">{t('landing.footer.privacy')}</Link>
              <Link to="/terms" className="text-slate-400 hover:text-[#0070E0] text-[13px] font-bold transition-colors">{t('landing.footer.terms')}</Link>
