...
const GuideLayout: React.FC<GuideLayoutProps> = ({ 
  ...
  useEffect(() => {
    ...
    if (metaTitle) {
      ...
      document.title = `${title} | Car Safety Diagnostic Hub`;
    }
      ...
      <div className="relative z-20">
        ...
        <footer className="border-t border-slate-100 bg-white py-20 px-6">
          <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
            ...
            {/* Brand Mark */}
            <div className="mb-12">
              <img src="/favicon.svg" alt="Car Safety Icon" className="w-12 h-12 shadow-lg shadow-navy/10" />
            </div>

            {/* Premium Wordmark */}
            <h4 className="text-2xl font-black text-slate-900 mb-12 flex items-center justify-center gap-2">
              <span className="font-display">Car Safety</span>
            </h4>
