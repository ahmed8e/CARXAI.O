...
const DISMISS_KEY = 'car safety_install_prompt_dismissed'
          ...
          <div className="flex gap-4 mb-6">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-display font-black text-on-surface italic tracking-tight sr-only">
                {isIOS ? 'Add Car Safety to Home' : 'Install Car Safety'}
              </h3>
              <p className="text-sm text-muted font-medium leading-relaxed mt-1">
                {isIOS 
                  ? 'Use Car Safety like an app for faster access and a better mobile experience.' 
