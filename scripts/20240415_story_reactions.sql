...
VALUES 
    ('car safety-origin', 'relate', 4800),
    ('car safety-origin', 'respect', 3100),
    ('car safety-origin', 'powerful', 2700)
...
-- Review the results
-- SELECT * FROM view_story_reaction_totals WHERE story_id = 'car safety-origin';
